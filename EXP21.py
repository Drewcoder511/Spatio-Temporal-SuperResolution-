...
hidden_size = 4
batch_size = 20
Encoder1 = GCN4(19, 19, use_bias=False)
Encoder2 = GCN4(19, 19, use_bias=False)
Encoder3 = GCN4(19, 19, use_bias=False)
Decoder = Lin(38, 5, 1)
...
for epoch in range(50):
    ...
    if Loss < best_valid_loss:
        ...
        print("save!")
    torch.save(valid_pred, "/Users/huoshengming/Downloads/Best_model/EXP21_best_pred"+str(epoch))